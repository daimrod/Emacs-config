...
(custom-theme-set-faces
 ...
 '(gnus-summary-high-ancient ((t (:bold t :foreground "dodger blue"))))
 ...
 '(mt-face ((t (:inverse-video t))))
 '(org-drill-hidden-cloze-face ((t (:foreground "deep sky blue"))))
 '(org-drill-visible-cloze-hint-face ((t (:foreground "light slate blue"))))
 '(success ((t (:weight bold))))
 '(term-color-green ((t (:foreground "#6ac214"))))
 '(vc-annotate-face-3F3FFF ((t (:background "black" :foreground "#3F3FFF"))))
 '(vc-annotate-face-3F6CFF ((t (:background "black" :foreground "#3F6CFF"))))
 '(vc-annotate-face-3F99FF ((t (:background "black" :foreground "#3F99FF"))))
 '(vc-annotate-face-3FC6FF ((t (:background "black" :foreground "#3FC6FF"))))
 '(vc-annotate-face-3FF3FF ((t (:background "black" :foreground "#3FF3FF"))))
 '(vc-annotate-face-3FFF56 ((t (:background "black" :foreground "#3FFF56"))))
 '(vc-annotate-face-3FFF83 ((t (:background "black" :foreground "#3FFF83"))))
 '(vc-annotate-face-3FFFDD ((t (:background "black" :foreground "#3FFFDD"))))
 '(vc-annotate-face-56FF3F ((t (:background "black" :foreground "#56FF3F"))))
 '(vc-annotate-face-83FF3F ((t (:background "black" :foreground "#83FF3F"))))
 '(vc-annotate-face-B0FF3F ((t (:background "black" :foreground "#B0FF3F"))))
 '(vc-annotate-face-DDFF3F ((t (:background "black" :foreground "#DDFF3F"))))
 '(vc-annotate-face-FF3F3F ((t (:background "black" :foreground "#FF3F3F"))))
 '(vc-annotate-face-FF6C3F ((t (:background "black" :foreground "#FF6C3F"))))
 '(vc-annotate-face-FF993F ((t (:background "black" :foreground "#FF993F"))))
 '(vc-annotate-face-FFC63F ((t (:background "black" :foreground "#FFC63F"))))
 '(vc-annotate-face-FFF33F ((t (:background "black" :foreground "#FFF33F"))))
 ...
 '(bold ((t (:weight bold))))
 '(company-preview ((t (:background "Skyblue4" :foreground "wheat"))))
 '(company-preview-common ((t (:inherit company-preview :foreground "chartreuse"))))
 '(company-preview-search ((t (:inherit company-preview :background "Skyblue3"))))
 '(company-scrollbar-bg ((t (:inherit company-tooltip :background "SkyBlue4"))))
 '(company-scrollbar-fg ((t (:background "SkyBlue4"))))
 '(company-template-field ((t (:background "SkyBlue3" :foreground "black"))))
 '(company-tooltip ((t (:background "SkyBlue4" :foreground "black"))))
 '(company-tooltip-common ((t (:inherit company-tooltip :foreground "chartreuse"))))
 '(company-tooltip-common-selection ((t (:inherit company-tooltip-selection :foreground "chartreuse"))))
 '(company-tooltip-selection ((t (:inherit company-tooltip :background "forest green"))))
 '(font-lock-fic-author-face ((t (:foreground "gold" :underline t))))
 '(font-lock-fic-face ((t (:foreground "dark orange" :weight bold))))
 '(hl-line ((t (:background "dark slate gray"))))
 '(org-scheduled-previously ((t (:foreground "firebrick1"))))
