...
(require 'config-defuns nil t)
(require 'config-bindings nil t)
(require 'config-theme nil t)
(require 'config-lisp nil t)
(require 'config-cc-mode nil t)
(require 'config-ediff nil t)
(require 'config-slime nil t)
(require 'config-yasnippet nil t)
(require 'config-misc nil t)
(require 'config-search nil t)
(require 'config-bbdb nil t)
(require 'config-git nil t)
(require 'config-alias nil t)
(require 'config-org nil t)
(require 'config-auto-complete nil t)
(require 'config-haskell nil t)
(require 'config-prolog nil t)
(require 'config-markdown nil t)
(require 'config-js nil t)
(require 'config-multi-term nil t)
(require 'config-smerge nil t)
(require 'config-ocaml nil t)
(require 'config-w3m nil t)
(require 'config-plantuml nil t)
(require 'config-xml nil t)
(require 'config-html nil t)
(require 'config-irc nil t)
(require 'config-scala nil t)
(require 'config-python nil t)
(require 'config-multiple-cursors nil t)
(require 'config-license nil t)
