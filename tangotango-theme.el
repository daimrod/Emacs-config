...
(custom-theme-set-faces
 ...
 '(magit-log-head-label-remote ((t (:background "Grey11" :foreground "DarkSeaGreen2" :box (:line-width 1 :color "DarkSeaGreen2" :style released-button)))))
 '(magit-log-head-label-local ((t (:background "Grey11" :foreground "LightSkyBlue1" :box (:line-width 1 :color "LightSkyBlue1" :style released-button)))))
 '(default ((t (:foreground "#eeeeec" :background "#2e3434" :stipple nil :inherit nil))))
 '(magit-log-head-label-tags ((t (:background "Grey11" :foreground "goldenrod4" :box (:line-width 2 :color "goldenrod4" :style released-button)))))
