...
(custom-theme-set-faces
 ...
 ;; - green :      "#6ac214"
 ;; - orange/red : "tomato"
 `(default ((t (:foreground "#eeeeec" :background "#2e3434" :stipple nil :inherit nil))))
 ...
 `(link ((t (:foreground "light sky blue" :underline (:color foreground-color :style line)))))
 ...
 `(gnus-group-mail-low-empty((t (:foreground "light sky blue"))))
 `(gnus-group-mail-low((t (:bold t :foreground "light sky blue"))))
 ...
 `(gnus-group-news-low-empty((t (:foreground "light sky blue"))))
 `(gnus-group-news-low((t (:bold t :foreground "light sky blue"))))
 ...
 `(org-level-1 ((t (:bold t :foreground "light sky blue" :height 1.5))))
 ...
 `(org-agenda-date-weekend ((t (:weight normal :foreground "light sky blue"))))
 ...
 `(ess-jb-h1-face ((t (:height 1.6 :foreground "light sky blue" :slant normal))))
 ...
 `(rpm-spec-tag-face ((t (:foreground "light sky blue" :weight bold))))
 `(rpm-spec-var-face ((t (:foreground "tomato"))))
 `(w3m-header-line-location-content ((t (:background "#2e3434" :foreground "burlywood3"))))
 `(w3m-tab-background ((t (:background "#2e3434"))))
 `(w3m-tab-unselected ((t (:background "#2e3434" :foreground "#eeeeec"))))
 `(w3m-tab-unselected-retrieving ((t (:background "#2e3434" :foreground "tomato3"))))
 `(w3m-tab-unselected-unseen ((t (:background "#2e3434" :foreground "lightskyblue3"))))
 `(w3m-tab-selected ((t (:background "#2e3434" :foreground "lightgoldenrod"))))
 `(w3m-tab-selected-retrieving ((t (:background "#2e3434" :foreground "tomato2")))))
